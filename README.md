This code can be used for automating the process of taking pictures of different angles of an BIM object that is uploaded to the usBIM online model viewer.
